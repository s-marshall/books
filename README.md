...
get the app created:
    ...
    $ heroku apps:create books
    Creating books... done, stack is cedar
    http://books.herokuapp.com/ | git@heroku.com:books.git
...
You can deploy the skeleton project immediately:
    ...
    [...]
    -----> Launching... done, v3
           http://books.herokuapp.com deployed to Heroku

    To git@heroku.com:books.git
     * [new branch]      master -> master

It's live! Hit it with `curl`:

    $ curl http://books.herokuapp.com
    ["Hello" :from Heroku]
...
Then you can launch the REPL:
    ...
    $ lein repl :connect http://$REPL_USER:$REPL_PASSWORD@books.herokuapp.com/repl
